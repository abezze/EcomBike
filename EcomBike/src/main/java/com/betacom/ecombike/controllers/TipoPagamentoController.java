...
@RestController
@RequestMapping("rest/tipopagamento")
public class TipoPagamentoController {
	
	private final IMessaggioServices    msgS;
	private final ITipoPagamentoServices    tipopagamentoServices;
	
	@PostMapping("/create")
	public ResponseEntity<Resp> create(@RequestBody(required = true)  TipoPagamentoReq req){
		Resp r = new Resp();
		HttpStatus status = HttpStatus.OK;
		try {
			tipopagamentoServices.create(req);
	...
	@PutMapping("/update")
	public ResponseEntity<Resp> update(@RequestBody(required = true)  TipoPagamentoReq req){
		Resp r = new Resp();
		HttpStatus status = HttpStatus.OK;
		try {
			tipopagamentoServices.update(req);
	...
	public ResponseEntity<Resp> delete(@PathVariable(required = true)  Long id){
		...
		HttpStatus status = HttpStatus.OK;
		try {
			tipopagamentoServices.delete(id);
	...
	public ResponseEntity<Object> findById (@RequestParam (required = true)  Long id){
		...
		HttpStatus status = HttpStatus.OK;
		try {
			r= tipopagamentoServices.findById(id);
		} catch (Exception e) {
			r=e.getMessage();
			status = HttpStatus.BAD_REQUEST;
		}
